...
- `ollama_academic_trainer/app.py` (`split_chunks`, `ollama_embedding`, `train_semantic_index`, `retrieve_context`, `answer_question`)
- `ollama_academic_trainer/templates/index.html`
- `ollama_academic_trainer/static/app.js`
- `ollama_academic_trainer/static/styles.css`
- `ollama_academic_trainer/benchmark.json`
